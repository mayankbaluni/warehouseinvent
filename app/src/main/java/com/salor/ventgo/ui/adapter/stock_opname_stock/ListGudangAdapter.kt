...
class ListGudangAdapter(private val context: Activity, private val item_homes: List<WarehouseList>,var listActivity : com.salor.ventgo.ui.activity.stock_opname_stock.ListGudangActivity) : RecyclerView.Adapter<ListGudangAdapter.MyViewHolder>() {
