...
class StockKeluarListAdapter(private val context: Activity, private val item_homes: List<StockListBarangKeluar>,var listActivity : StockKeluarListActivity) : RecyclerView.Adapter<StockKeluarListAdapter.MyViewHolder>() {
