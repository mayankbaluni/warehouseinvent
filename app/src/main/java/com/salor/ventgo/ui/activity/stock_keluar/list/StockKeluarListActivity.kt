...
import kotlinx.android.synthetic.main.activity_stock_keluar_list.*
...
class StockKeluarListActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_stock_keluar_list)
    ...
    fun setData() {
        ...
        rvList.setAdapter(stockKeluarListAdapter)
