...
public class StockBarangDetail {
    ...
    @Expose
    private List<WarehouseStock> warehouse = null;
    ...
    public List<WarehouseStock> getWarehouse() {
        return warehouse;
    }

    public void setWarehouse(List<WarehouseStock> warehouse) {
